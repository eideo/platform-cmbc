 ...
 * 
 */
package com.zlebank.zplatform.cmbc.withholding.response.bean;
 ...
 */
@XStreamAlias("Ans")
public class RealTimeWithholdingQueryResultBean implements Serializable {
    /**
     * serialVersionUID
     */
    ...
    /**
     * @param oripayserialno
     *            the oripayserialno to set
     */
