 ...
 * 
 */
package com.zlebank.zplatform.cmbc.withholding.request.bean;
 ...
 */
@XStreamAlias("Req")
public class RealNameAuthQueryBean implements Serializable{
    ...
    public RealNameAuthQueryBean(
        ...
        this.serialno = OrderNumber.getInstance().generateRealNameQueryOrderNo();
     ...
     * @param resv
     */
    public RealNameAuthQueryBean(String version, String transdate,
