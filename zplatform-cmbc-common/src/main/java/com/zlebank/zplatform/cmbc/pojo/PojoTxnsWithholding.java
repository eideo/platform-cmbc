...
import com.zlebank.zplatform.cmbc.common.enums.BiztypeEnum;
...
public class PojoTxnsWithholding implements java.io.Serializable {
    ...
    public PojoTxnsWithholding() {
    }

    public PojoTxnsWithholding(long tid) {
        this.tid = tid;
    }
    public PojoTxnsWithholding(long tid, String serialno, String merid,
    ...
    public PojoTxnsWithholding(PojoRealnameAuth realnameAuth) {
        ...
        this.servicecode = Constant.REALNAMEAUTH;
    ...
    public PojoTxnsWithholding(PojoRealnameAuth realnameAuth,ChannelEnmu channelEnmu) {
    	if(channelEnmu==ChannelEnmu.CHANPAYCOLLECTMONEY){
            ...
            this.transdate = DateUtil.getCurrentDate();
            this.transtime = DateUtil.getCurrentTime();
            this.servicecode = Constant.REALNAMEAUTH_CHANPAY;
    ...
    public PojoTxnsWithholding(String bankinscode,String bankname,String bankaccno,String bankaccname,String bankacctype,String certtype,String certno,String mobile) {
        this.serialno = OrderNumber.getInstance().generateRealNameOrderNo();
        this.merid = Constant.getInstance().getCmbc_merid();
        this.mername = Constant.getInstance().getCmbc_mername();
        this.transdate = DateUtil.getCurrentDate();
        this.transtime = DateUtil.getCurrentTime();
        this.servicecode = Constant.WHITELIST;
    ...
    public PojoTxnsWithholding(String bankinscode,String bankname,String bankaccno,String bankaccname,String bankacctype,String certtype,String certno,String mobile,ChannelEnmu channelEnmu) {
    	if(channelEnmu==ChannelEnmu.CHANPAYCOLLECTMONEY){
    		this.serialno = OrderNumber.getInstance().generateRealNameOrderNo();
	        this.merid = Constant.getInstance().getChanpay_cj_merchant_id();
	        this.mername = Constant.getInstance().getChanpay_cj_merchant_name();
	        this.transdate = DateUtil.getCurrentDate();
	        this.transtime = DateUtil.getCurrentTime();
	        this.servicecode = Constant.PROTOCOLSIGN_CHANPAY;
	        this.cardtype = bankacctype;
	        this.accno = bankaccno;
	        this.accname = bankaccname;
	        this.certtype = certtype;
...
//        this.serialno = OrderNumber.getInstance().generateRealNameOrderNo();
    ...
    public PojoTxnsWithholding(String oritransdate,String orireqserialno,String txnseqno,ChannelEnmu channel) {
        ...
        /*switch (channel) {
            ...
            case CMBCSELFWITHHOLDING:
                ...
                this.transdate = DateUtil.getCurrentDate();
                this.transtime = DateUtil.getCurrentTime();
                this.servicecode = Constant.WITHHOLDINGSELFQUERY;
                this.orireqserialno = orireqserialno;
                this.oritransdate = oritransdate;
                this.txnseqno = txnseqno;
                this.chnlcode = channel.getChnlcode();
    ...
    public PojoTxnsWithholding(TradeBean trade,ChannelEnmu channel) {
        switch (channel) {
            case CMBCWITHHOLDING :
                this.merid = Constant.getInstance().getCmbc_merid();;
                this.mername = Constant.getInstance().getCmbc_mername();;
                this.transdate = DateUtil.getCurrentDate();
                this.transtime = DateUtil.getCurrentTime();;
                this.servicecode = Constant.WITHHOLDING;
            ...
            case  CMBCSELFWITHHOLDING:
                ...
                this.transdate = DateUtil.getCurrentDate();
                this.transtime = DateUtil.getCurrentTime();;
                this.servicecode = Constant.WITHHOLDINGSELF;
                this.cardtype = CMBCCardTypeEnum.fromCardType(trade.getCardType()).getCode();
                this.accno = trade.getCardNo();
                this.accname = trade.getAcctName();
                this.certtype = CertifTypeEnmu.fromValue("01").getCmbcCode();
           ...
           /* case CHANPAYCOLLECTMONEY:
                ...
                this.transdate = DateUtil.getCurrentDate();
                this.transtime = DateUtil.getCurrentTime();;
                this.servicecode = Constant.WITHHOLDING_CHANPAY;
               ...
               // this.expired = (StringUtil.isEmpty(trade.getMonth())?"":trade.getMonth())+(StringUtil.isEmpty(trade.getYear())?"":trade.getYear());
                this.biztype = Constant.getInstance().getChanpay_cj_business_code();
                this.bizno = Constant.getInstance().getChanpay_cj_product_no();
               // this.bizobjtype = "00";
                this.tranamt = new BigDecimal(Long.valueOf(trade.getAmount()));
                this.currency = "RMB";
                this.purpose = "代收业务";
