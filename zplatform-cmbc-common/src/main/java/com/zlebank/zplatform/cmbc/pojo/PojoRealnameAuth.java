 ...
 */
@Entity
@Table(name="T_REALNAME_AUTH")
public class PojoRealnameAuth {
    /**标识**/
    private Long id;
    /**商户代码**/
    ...
    @GenericGenerator(name = "id_gen", strategy = "enhanced-table", parameters = {
            ...
            @Parameter(name = "segment_value", value = "REALNAME_AUTH_ID"),
    ...
    public PojoRealnameAuth(TradeBean trade) {
        ...
        this.expired = StringUtils.isNotEmpty(trade.getValidthru())? trade.getValidthru(): trade.getMonth()+trade.getYear();
        this.status = "01";
       
    }
    public PojoRealnameAuth() {
        super();
        // TODO Auto-generated constructor stub
    }
    /*public PojoRealnameAuth(WapCardBean cardBean) {
        super();
        this.cardNo = cardBean.getCardNo();
        this.cardType = cardBean.getCardType();
        this.customerNm = cardBean.getCustomerNm();
        this.certifTp = cardBean.getCertifTp();
        this.certifId = cardBean.getCertifId();
        this.phoneNo = Long.valueOf(cardBean.getPhoneNo());
        this.cvn2 = cardBean.getCvn2();
        this.expired = cardBean.getExpired();
        this.status = "01";
